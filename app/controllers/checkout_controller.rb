...
def create
  ...
  session = Stripe::Checkout::Session.create(
    ...
    mode: 'payment',
    success_url:  'https://ambrosia-drive-git-development-gillianlevert.vercel.app/checkout?success=true',     
    cancel_url: 'https://ambrosia-drive-git-development-gillianlevert.vercel.app/checkout?success=false',
  )
